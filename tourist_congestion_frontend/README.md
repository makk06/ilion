...
전국 자체 추정은 `CrowdEstimate`의 5단계를 기본으로 표시합니다. 기존 `CrowdLevel`은 서울시 제공 관측의 4단계 호환 모델입니다. 낮은 신뢰도·개발 샘플·오래된 입력·폐장은 명시하고 추천 가점을 제한합니다. 계약과 실행 조건은 [혼잡도 운영 안내](../docs/crowd-estimation.md), 실제 검사 결과는 [검증 기록](../docs/crowd-verification-20260912.md)을 참고하세요.
