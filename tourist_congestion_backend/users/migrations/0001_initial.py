# Generated by Django 6.0.6 on 2026-08-08 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(choices=[('email', 'Email'), ('google', 'Google')], default='email', max_length=10)),
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('active', 'Active'), ('withdrawn', 'Withdrawn')], default='active', max_length=10)),
