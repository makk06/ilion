...
RECOMMENDATION_CONTEXT_CACHE_SECONDS = max(
    0, min(300, int(os.environ.get('RECOMMENDATION_CONTEXT_CACHE_SECONDS', '300')))
)
RECOMMENDATION_CONTEXT_REUSE_KM = max(
    0, min(5, float(os.environ.get('RECOMMENDATION_CONTEXT_REUSE_KM', '1')))
)
